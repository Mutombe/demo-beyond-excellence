  ...
  return (
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
      ...
      >
        ...
        >
          ...
          <p className="text-white/30 text-xs sm:text-sm uppercase tracking-[0.2em]" style={{ fontFamily: 'var(--font-sans)' }}>
            {hero.trustBadge} &middot; 7185 &middot; Est. 2015
          </p>
        </motion.div>
      ...
      <div className="hidden lg:flex absolute right-8 bottom-12 z-20">
        ...
        >
          Beyond Excellence &mdash; Harare, Zimbabwe
        </span>
      </div>
    </section>
  );
...
function ServicesGrid() {
  ...
  const serviceImages = ['https://images.unsplash.com/photo-1519741497674-611481863552?w=800&q=80', 'https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?w=800&q=80', 'https://images.unsplash.com/photo-1511795409834-ef04bbd61622?w=800&q=80', 'https://images.unsplash.com/photo-1530103862676-de8c9debad1d?w=800&q=80', 'https://images.unsplash.com/photo-1519741497674-611481863552?w=800&q=80', 'https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?w=800&q=80'];
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <p className="text-white/50 text-sm sm:text-base leading-relaxed mb-6 max-w-lg" style={{ fontFamily: 'var(--font-sans)' }}>
              Founded with a singular mission: to deliver the highest quality events decor services in Zimbabwe. What began as a small operation has grown into one of Harare's most trusted names.
            </p>
            <p className="text-white/35 text-sm leading-relaxed max-w-lg" style={{ fontFamily: 'var(--font-sans)' }}>
              Today, with a team of experienced professionals and 14+ satisfied clients, our track record speaks for itself. We bring the same meticulous attention to detail to every single project.
            </p>
            ...
            <div className="flex gap-10 sm:gap-16">
              ...
              <div>
                <div className="text-gold-500 font-heading text-3xl sm:text-4xl italic leading-none">14+</div>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-8 -left-6 sm:-left-10 w-[45%] overflow-hidden border-4 border-navy-950 shadow-2xl">
                <img
                  ...
                  alt="Beyond Excellence detail work"
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            <img
              ...
              alt="Beyond Excellence quality work"
              className="w-full aspect-[4/5] object-cover object-center"
              loading="lazy"
            />
          ...
          >
            ...
            <h2 className="font-heading text-white leading-[0.95] italic mb-12" style={{ fontSize: 'clamp(2rem, 4.5vw, 3rem)' }}>
              Why Choose <span className="text-gold-500">Beyond</span>
            </h2>
    ...
    <section ref={ref} className="relative py-28 sm:py-36 lg:py-48 overflow-hidden">
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <img
          ...
          alt="Beyond Excellence services"
